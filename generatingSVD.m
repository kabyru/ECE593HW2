...
newMN = newM/newM(12);
rebuiltSVD = U*S*transpose(V);

%Now, normalize conversions using newMN to prove that this projection
%matrix provides the same results
twoD1New = newMN*threeD1;
twoD1NewN = twoD1New/twoD1New(3);

twoD2New = newMN*threeD2;
twoD2NewN = twoD2New/twoD2New(3);

twoD3New = newMN*threeD3;
twoD3NewN = twoD3New/twoD3New(3);

twoD4New = newMN*threeD4;
twoD4NewN = twoD4New/twoD4New(3);

twoD5New = newMN*threeD5;
twoD5NewN = twoD5New/twoD5New(3);

twoD6New = newMN*threeD6;
twoD6NewN = twoD6New/twoD6New(3);

twoD7New = newMN*threeD7;
twoD7NewN = twoD7New/twoD7New(3);

twoD8New = newMN*threeD8;
twoD8NewN = twoD8New/twoD8New(3);

twoD9New = newMN*threeD9;
twoD9NewN = twoD9New/twoD9New(3);

twoD10New = newMN*threeD10;
twoD10NewN = twoD9New/twoD10New(3);

twoD11New = newMN*threeD11;
twoD11NewN = twoD11New/twoD11New(3);

twoD12New = newMN*threeD12;
twoD12NewN = twoD12New/twoD12New(3);